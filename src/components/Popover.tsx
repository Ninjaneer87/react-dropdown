...
const Popover = ({
  ...
  useEffect(() => {
    function handleClickOutside(event: MouseEvent) {
      const hasPopoverParent = (event.target as Element)?.closest('.popover-menu');
